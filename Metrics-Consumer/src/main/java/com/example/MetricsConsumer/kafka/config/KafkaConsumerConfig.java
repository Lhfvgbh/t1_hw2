package com.example.MetricsConsumer.kafka.config;
...
class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Metric>> kafkaListenerContainerFactory() {
